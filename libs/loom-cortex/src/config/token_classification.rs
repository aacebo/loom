...
pub struct CortexTokenClassificationConfig {
...
impl CortexTokenClassificationConfig {
    pub fn new(model: CortexModelType) -> CortexTokenClassificationConfigBuilder {
        CortexTokenClassificationConfigBuilder::new(model)
    }
}

impl Default for CortexTokenClassificationConfig {
    fn default() -> Self {
        Self {
...
pub struct CortexTokenClassificationConfigBuilder {
...
impl CortexTokenClassificationConfigBuilder {
    ...
    pub fn build(self) -> CortexTokenClassificationConfig {
        CortexTokenClassificationConfig {
            model: self.model,
            source: self.source,
            device: self.device,
...
impl CortexTokenClassificationConfig {
    pub fn into_pos_config(self) -> pos_tagging::POSConfig {
        pos_tagging::POSConfig::from(token_classification::TokenClassificationConfig::from(self))
    }
}

impl From<CortexTokenClassificationConfig> for token_classification::TokenClassificationConfig {
