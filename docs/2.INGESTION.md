...
├── <span><a href="./2.INGESTION.md"><b>Ingestion</b></a> 👈</span>
...
flowchart TB
  ...
  %% Post-processing
  Store([Store])
  Recall(["<a href="https://github.com/aacebo/merc/blob/main/docs/3.RECALL.md">Recall</a>"])
  Reinforce([Reinforce])
  ...
  Recall e15@--> Reinforce
  e15@{ animate: true }

  Reinforce e16@--> Reclassify
  e16@{ animate: true }

  Reclassify e17@--> Store
  e17@{ animate: true }
...
By measuring the input using a classifier against our significant [datapoints](./1.MEMORY.md#datapoints-5), we can create a weighted score.
