...
└── <a href="../README.md">▾ 6. Research/</a>
    ...
    └── <a href="./README.md">▾ 6.3 Analysis/</a>
        ...
        ├── <span><a href="./2.loom-vs-zep.md"><b>6.3.2 Loom vs Zep</b></a> 👈</span>
...
**Key difference:** Loom gates at write time with scoring, accepting or rejecting each input. Zep stores everything in a temporal knowledge graph and filters at read time via sophisticated retrieval and reranking.
...
**Both accept**, but through different mechanisms: Loom via scoring, Zep via graph construction.
...
**Result:** Loom explicitly rejects; Zep stores but naturally deprioritizes through graph structure.
...
**Key difference:** Zep's bi-temporal model handles contradictions automatically; Loom stores both without invalidation logic.
...
| Metric | Loom | Zep | Delta |
|--------|------|-----|-------|
| **Write Latency** | ~100-150ms | ~1-5s | 7-50x faster (Loom) |
| **Write Cost** | ~$0.0002 | ~$0.01-0.05 | 50-250x cheaper (Loom) |
| **Storage per Input** | 0 or 1 record | 2-10 nodes/edges | 2-10x less (Loom) |
...
- **Loom** asks: "Is this important enough to remember?" (selective, efficient)
...
| Dimension | Loom | Zep | Delta | Winner |
|-----------|------|-----|-------|--------|
| **Write latency** | ~100-150ms | ~1-5s | 7-50x faster | **Loom** |
| **Write cost** | ~$0.0002 | ~$0.01-0.05 | 50-250x cheaper | **Loom** |
| **Storage efficiency** | Selective storage | Stores everything | 2-10x less | **Loom** |
...
| **Operational simplicity** | 2 classifiers | Graph DB + LLM | - | **Loom** |

**Loom** prioritizes efficiency, cost, and simplicity for write-time filtering.
**Zep** prioritizes temporal reasoning, retrieval sophistication, and comprehensive capture.

**Bottom Line:**

- **Choose Loom** for high-volume ingestion where storage costs matter and you handle retrieval externally
- **Choose Zep** for applications requiring temporal reasoning, contradiction resolution, and sophisticated retrieval
- **They solve different problems:** Loom is a write-time filter; Zep is a complete memory system with retrieval
