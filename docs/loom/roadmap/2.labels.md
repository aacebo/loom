...
└── <a href="../../README.md">▾ 6. Research/</a>
    ...
    │       ├── <span><a href="./2.labels.md"><b>6.1.2.2 Label Expansion</b></a> 👈</span>
...
|----|------|--------------|---------------|
| LOOM-004 | Negative Labels | 3 | 20-30% noise reduction |
| LOOM-005 | Positive Labels | 6 | 10-15% recall |
| LOOM-006 | Sensitivity Labels | 2 | Downstream routing |
| LOOM-007 | Temporal Labels | 3 | Temporal awareness |
...
**Zep** stores everything but naturally deprioritizes low-value content through graph sparsity. Loom's approach is more explicit—reject at write time to reduce storage and downstream noise.
...
**Hindsight** separates memories into epistemic networks (World/Experience/Opinion/Observation). These new labels help Loom better categorize the *type* of information being stored, enabling smarter downstream routing.
...
## LOOM-006: Sensitivity Labels

**Status:** 🔲 Not Started

### Problem

Loom has no awareness of content sensitivity. Downstream systems need to know if content requires special handling.
...
Loom's sensitivity labels provide a simpler binary signal that downstream systems can use to apply their own retention/handling policies.
...
## LOOM-007: Temporal Labels

**Status:** 🔲 Not Started

### Problem

Loom has no awareness of temporal content. Time-sensitive information (deadlines, updates, schedules) isn't explicitly detected.
...
Loom can't do bi-temporal reasoning (it's stateless), but these labels help downstream systems:
